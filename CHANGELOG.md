...
Performance profile is now retired.
...
**This update is save safe if you follow the steps on Discord**
...
I'm not completely sure if swapping from OBody to Autobody mid save is safe, so if you're still early in your playthrough I'd recommend to restart.
 ...
 - "Experimental" cell transition crash fix is now enabled by default because I don't believe there are any real downsides to it and many users have reported it works.
...
Make sure Quick Light is not active before updating and preferably get rid of your vanity mirror by dropping it on ground, opening console, clicking on the vanity mirror, and entering `markfordelete` in the console.
