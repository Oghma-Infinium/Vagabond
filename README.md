...
**Note:** Making *any* changes to the list counts as modification and thus voids official support. Even the smallest changes such as editing configurations counts as modification. Only changes explicitly stated in [config](https://github.com/Oghma-Infinium/Vagabond/blob/main/Documentation/CONFIG.md) are supported. There is separate channel in Discord for discussing modifications to Vagabond.
...
- Unable to download `Data_ccBGSSSE037-Curios.esl (GameFileSourceDownloader+State|SkyrimSpecialEdition|1.6.1130.0|data\ccbgssse037-curios.esl)`, Unable to download `Data_ccBGSSSE037-Curios.bsa (GameFileSourceDownloader+State|SkyrimSpecialEdition|1.6.1130.0|data\ccbgssse037-curios.bsa)`
